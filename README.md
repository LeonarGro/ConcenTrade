...
- **Raphaël Ducournau** : paramètres globaux, système d'authentification/session et logique de collection de cartes et Architecture de données (Supabase).
...
- **Volcy Desmazures** : Navigation, et tutoriel interactif.
